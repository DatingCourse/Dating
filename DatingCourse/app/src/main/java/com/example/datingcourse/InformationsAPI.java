...
public class InformationsAPI extends AppCompatActivity {
    ...
    class NetworkTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String xmlResponse) {
            ...
            if (xmlResponse != null) {
                ...
                if (MapChoiceActivity.datasListener != null) {
                    MapChoiceActivity.datasListener.onDataReceived(titles, images, address, x, y, tel);
                } else {
                    Log.d("error", "error");
                }
            }
